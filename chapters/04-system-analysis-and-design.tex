...
This chapter presents \textbf{Sprint 1}, dedicated to system analysis and design. During this sprint, the objective was not to implement functional modules yet, but to understand the source systems, define user needs, identify the required data scope, and prepare the main design artifacts that would guide the following development sprints.
...
The Sprint 1 backlog focused on analysis, modeling, and architectural preparation for the rest of the project.
...
\begin{center}
	...
	\begin{tabular}{|l|>{\raggedright\arraybackslash}p{10.2cm}|l|}
		...
		\hline
		S1-BL-01 & Identify the main system actors and define their access scope and responsibilities. & High \\
		\hline
		S1-BL-02 & Model the global use case diagram of the platform and describe the principal user interactions. & High \\
		\hline
		S1-BL-03 & Explore the BioTime and EasyProject schemas and select the tables required for integration. & High \\
		\hline
		S1-BL-04 & Design SQL views that simplify ETL extraction from the two source systems. & High \\
		\hline
		S1-BL-05 & Define the initial unified PostgreSQL target schema and key integration constraints. & High \\
		\hline
		S1-BL-06 & Establish the main application diagram and the global system architecture used as the reference for later sprints. & Medium \\
		\hline
	\end{tabular}
\end{center}

\section{Sprint Design}
Sprint 1 design aimed to transform a business problem into a structured technical solution. The design effort started with user and access analysis, then moved to source-system exploration, and finally to the high-level architecture that would orient ETL and application development.
...
The global use case diagram was produced during Sprint 1 to consolidate the functional perimeter of the future application and establish a shared understanding of actor responsibilities.
...
\section{Conception}
The conception phase of Sprint 1 consolidated the main design artifacts that would guide subsequent implementation. It covered the target data structure, the integration constraints, and the global technical architecture of the solution.
...
At the end of Sprint 1, the main outcome was a complete analysis and design baseline that structured the rest of the project. Even though no final user-facing module was delivered yet, this sprint produced the essential functional and technical artifacts used in the following iterations.

\subsection{Main Deliverables of Sprint 1}
\begin{itemize}[noitemsep]
	...
	\item Established the main application diagram and the end-to-end global architecture.
\end{itemize}

\subsection{Sprint 1 Contribution to the Next Sprints}
Sprint 1 served as the foundation for all later work. The ETL sprint relied on the selected tables, source views, and target schema defined here. The authentication and business-module sprints also reused the actor definitions, access scope, and architecture decisions established during this initial analysis and design phase.

\section{Chapter Conclusion}
This chapter presented \textbf{Sprint 1: System Analysis and Design}. It established the functional and technical foundation of the project by identifying actors and use cases, exploring the source systems, preparing the ETL-oriented data structure, and defining the global architecture of the solution.
