\chapter{Admin Dashboard and Project Assignment}
\minitoc
\clearpage
\section{Introduction}
This chapter presents Sprint 3, focused on the Admin Dashboard and Project Assignment features, which give administrators full control over user governance and project-manager assignments. The chapter is organized around two main pages: Dashboard and Projects.

\section{Sprint Backlog}
The Sprint 3 backlog focused on governance and control features:
\begin{table}[H]
\centering
...
\hline
S3-BL-01 & Build a dashboard to monitor account distribution by role (Admin, HR, Project Manager). & High \\
\hline
S3-BL-02 & Allow administrators to create, edit, and delete user accounts. & High \\
\hline
S3-BL-03 & Provide controlled user editing while preventing direct password modification from the listing workflow. & Medium \\
\hline
S3-BL-04 & Allow administrators to assign project managers to projects. & High \\
\hline
S3-BL-05 & Add filtering, pagination, and scalable table behavior for large datasets. & Medium \\
\hline
\end{tabular}
\caption{Sprint 3 backlog}
\label{tab:sprint-3-backlog}
...
The Dashboard page was designed as the administrator control center. It contains user summary cards (Admin, HR, and Project Manager counts) and a users table with account-management actions.
...
\section{Conception}
\subsection{Admin dashboard and project assignment use case diagram}
The Admin Dashboard and Project Assignment use case model defines the main administrator interactions: create, edit, and delete accounts; view role distribution; consult projects; and assign project managers.
...
\IfFileExists{diagrams/ch5-admin-use-case.jpg}{%
    ...
    \textit{Insert Admin Dashboard and Project Assignment use case diagram.}
    \vspace{1.6cm}
    }}
}
\caption{Admin Dashboard and Project Assignment Use Case Diagram}
...
\subsection{Admin dashboard and users interface}
\begin{figure}[H]
\centering
...
\caption{Admin Dashboard: User Cards and Users Table}
...
\IfFileExists{assets/admin/projects-page.jpg}{%
    ...
    \textit{Insert Project Assignment projects page screenshot.}
    \vspace{1.6cm}
    }}
}
\caption{Project Assignment Projects Page}
...
\caption{Admin Settings Page for Data Synchronization}
...
\section{Conclusion}
The Admin Dashboard and Project Assignment features delivered complete governance capabilities for users and project assignments. With scalable tables, controlled actions, and cached data access, these features support efficient administrator work even with large datasets.
