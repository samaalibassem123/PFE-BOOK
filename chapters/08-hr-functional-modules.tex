\chapter{HR Functional Modules}
\minitoc
\clearpage
\section{Introduction}
This chapter presents the HR Functional Modules, designed to support organization-wide employee monitoring and follow-up. The module is organized into three main pages: Employees, Check-In/Out, and Employee Leave.

\section{Sprint Backlog}
The HR backlog focused on visibility, traceability, and fast navigation across workforce data.
...
\begin{center}
	...
	\begin{tabular}{|l|>{\raggedright\arraybackslash}p{10.2cm}|l|}
		...
		\hline
		HR-BL-01 & Implement an Employees page with searchable and filterable employee directory data. & High \\
		\hline
		HR-BL-02 & Add department-based analytics using a donut chart for employee distribution. & Medium \\
		\hline
		HR-BL-03 & Implement a Check-In/Out page for attendance follow-up with date-based filtering. & High \\
		\hline
		HR-BL-04 & Implement an Employee Leave page to explain missing check-in/out events. & High \\
		\hline
		HR-BL-05 & Add cross-page navigation from attendance rows to pre-filtered leave results. & Medium \\
		\hline
		HR-BL-06 & Ensure pagination and filtering for large datasets using scalable table technologies. & High \\
		\hline
	\end{tabular}
\end{center}
...
\begin{figure}[H]
	...
	\IfFileExists{diagrams/ch6-hr-use-case.jpg}{%
		...
		\fbox{\parbox{0.9\textwidth}{
				...
				\textit{Insert HR module use case diagram.}
				\vspace{1.6cm}
		}}
	}
	\caption{HR Functional Modules Use Case Diagram}
...
\section{Conclusion}
The HR Functional Modules delivered a complete workflow for employee monitoring, attendance follow-up, and leave-based explanation of missing events. With scalable tables, smart navigation, and cached data access, the module supports efficient HR operations on large datasets.
