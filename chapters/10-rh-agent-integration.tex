...
\label{fig:rh-agent-flow}
                                ...
                                \centering
                                \vspace*{\fill}
                                \IfFileExists{diagrams/rh-agent/rh-agent-sequence-diagram.jpg}{%
                                    \includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{diagrams/rh-agent/rh-agent-sequence-diagram.jpg}
                                    }{%
                                        \fbox{\parbox{0.9\textwidth}{
                                            \centering
                                                \vspace{2.0cm}
                                                    \textit{Missing file: diagrams/rh-agent/rh-agent-sequence-diagram.jpg}\\
